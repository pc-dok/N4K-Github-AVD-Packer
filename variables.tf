...
# so make the command: az ad sp create-for-rbac --role="Contributor" --scopes="/subscriptions/yoursubid" and create in terraform cloud variables in your Workspace
# TF_VAR_ARM_TENANT_ID TF_VAR_ARM_SUBSCRIPTION TF_VAR_ARM_CLIENT_ID TF_VAR_ARM_CLIENT_SECRET
